...
pub struct Cli {
    ...
    #[arg(long, default_value_t = markdown_org_extract::DEFAULT_MAX_TASKS, value_parser = validate_max_tasks, help_heading = "Limits")]
    pub max_tasks: usize,
...
impl Cli {
    ...
    pub fn agenda_scope(&self) -> markdown_org_extract::AgendaScope {
        use markdown_org_extract::AgendaScope;
